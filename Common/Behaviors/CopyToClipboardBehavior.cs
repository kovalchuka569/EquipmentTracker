...
{
    public static readonly DependencyProperty CopiedTextProperty = DependencyProperty.Register(nameof(CopiedText), typeof(string), typeof(CopyToClipboardBehavior));
