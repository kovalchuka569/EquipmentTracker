...
namespace UI.ViewModels
{
    ...
    public class AuthorizationViewModel : BindableBase, INavigationAware
    {
        ...
        {
            Console.WriteLine("Инициализация AuthorizationViewModel started...");
            try
            {
            ...
            Console.WriteLine("Инициализация AuthorizationViewModel completed!");
        }
        #endregion
        ...
        {
            Console.WriteLine("AuthorizationViewModel: OnNavigatedTo");
        }
        ...
        {
            Console.WriteLine("AuthorizationViewModel: OnNavigatedFrom");
        }
    }
}
