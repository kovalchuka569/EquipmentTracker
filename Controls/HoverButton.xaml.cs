...
public partial class HoverButton
{
    ...
    public static readonly DependencyProperty IconPositionProperty = DependencyProperty.Register(nameof(IconPosition), typeof(IconPosition), typeof(HoverButton), new PropertyMetadata(IconPosition.Left));
    ...
    public static readonly DependencyProperty TextFontFamilyProperty = DependencyProperty.Register(nameof(TextFontFamily), typeof(FontFamily), typeof(HoverButton), new PropertyMetadata(new FontFamily("Segoe UI")));
